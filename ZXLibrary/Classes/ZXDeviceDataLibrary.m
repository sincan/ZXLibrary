...
@interface ZXDeviceDataLibrary()

@property (nonatomic, assign) DiviceType iDevice;

@end

@implementation ZXDeviceDataLibrary

+ (instancetype)sharedLibrary; {
    static ZXDeviceDataLibrary *_librery;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _librery = [[ZXDeviceDataLibrary alloc] init];
